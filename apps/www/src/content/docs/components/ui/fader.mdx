...
<Preview name="fader-vertical-demo" />
...
<Preview name="block-channel-strip-fader-gain-db" />

#### Normalized range (`0..100`)

<Preview name="block-channel-strip-fader" />

#### Multi-channel strip

<Preview name="block-channel-strip-fader-multi" />
