...
<Preview name="fader-vertical-live-demo" />
...
<Preview name="fader-horizontal-live-demo" />

### Size variants

<Preview name="fader-size-variants-demo" />

### Thumb marks variants

<Preview name="fader-thumb-marks-variants-demo" />

### Gain range in dB (`-60..+6`)

<Preview name="fader-bipolar-db-demo" />
...
<Callout variant="info">
  For low-level composition (`FaderPrimitive.Root`, `Track`, `Range`, `Thumb`, etc.), see [@audio-ui/react on npm](https://www.npmjs.com/package/@audio-ui/react).
</Callout>
