...
`XYPad` accepts style props (`size`, `formatValue`, `showValueDisplay`, `className`) plus primitive props from `XYPadPrimitive.RootProps`.
...
<Callout variant="info">
  For low-level composition (`XYPadPrimitive.Root`, `Slider`, `Grid`, `Crosshair`, `Cursor`, etc.), see [@audio-ui/react on npm](https://www.npmjs.com/package/@audio-ui/react).
</Callout>
