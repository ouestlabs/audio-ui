...
This slider extends the shadcn/ui slider component to add support for a `bufferValue` prop, which displays a buffer indicator behind the current value. This is useful for media players to show loading progress.
