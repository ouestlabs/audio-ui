...
<Preview name="player-variant-demo" />

### Sizes

<Preview name="player-size-demo" />
...
<Preview name="player-track-demo" />

### Default

<Preview name="player-track-list-demo" />

### Grid

<Preview name="player-track-list-grid-demo" />

### Sortable

<Preview name="player-track-sortable-list-demo" />

### Sortable Grid

<Preview name="player-track-sortable-list-grid-demo" />
...
<Preview name="player-queue-simple-demo" />

### All controls

<Preview name="player-queue-all-controls-demo" />

### Shuffle and repeat

<Preview name="player-queue-shuffle-repeat-demo" />

### Preferences

<Preview name="player-queue-preferences-demo" />
...
<Preview name="player-playback-speed-demo" />
