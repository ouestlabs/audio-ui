...
<ComponentPreview styleName="base-nova" name="block-channel-strip" />
...
<ComponentSource
  styleName="base-nova"
  name="channel-strip"
  title="components/channel-strip.tsx"
/>
...
<ComponentPreview styleName="base-nova" name="block-channel-strip-horizontal" />
...
<ComponentPreview styleName="base-nova" name="block-channel-strip-knob-pan-width" />
