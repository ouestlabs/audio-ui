...
<ComponentPreview styleName="base-nova" name="player-stacked-demo" />
...
<ComponentPreview styleName="base-nova" name="player-demo" />

### With queue

<ComponentPreview styleName="base-nova" name="player-queue-demo" />

### Variants

<ComponentPreview styleName="base-nova" name="player-variant-demo" />

### Sizes

<ComponentPreview styleName="base-nova" name="player-size-demo" />
...
<ComponentPreview styleName="base-nova" name="player-track-demo" />

### Default

<ComponentPreview styleName="base-nova" name="player-track-list-demo" />

### Grid

<ComponentPreview styleName="base-nova" name="player-track-list-grid-demo" />

### Sortable

<ComponentPreview styleName="base-nova" name="player-track-sortable-list-demo" />

### Sortable Grid

<ComponentPreview styleName="base-nova" name="player-track-sortable-list-grid-demo" />
...
| `media`    | `React.ReactNode`            | -       | Left-side content, e.g. `<AudioTrackCover />`.     |
| `actions`  | `React.ReactNode`            | -       | Right-side content, e.g. `<AudioTrackPlayPauseAction />`. |
...
<ComponentPreview styleName="base-nova" name="player-queue-simple-demo" />

### All controls

<ComponentPreview styleName="base-nova" name="player-queue-all-controls-demo" />

### Shuffle and repeat

<ComponentPreview styleName="base-nova" name="player-queue-shuffle-repeat-demo" />

### Preferences

<ComponentPreview styleName="base-nova" name="player-queue-preferences-demo" />
...
<ComponentPreview styleName="base-nova" name="player-playback-speed-demo" />
