  ...
  return (
    <MenuPrimitive.Portal>
      ...
      >
        <MenuPrimitive.Popup
          className={cn(
            "cn-dropdown-menu-content cn-menu-target",
            ...
            "relative z-50 max-h-(--available-height) w-(--anchor-width) min-w-48 origin-(--transform-origin) overflow-y-auto overflow-x-hidden outline-none duration-100",
            "data-closed:animate-out data-open:animate-in data-closed:overflow-hidden",
            className
          )}
          data-menu-translucent=""
