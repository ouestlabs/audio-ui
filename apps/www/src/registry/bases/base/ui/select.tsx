    ...
    <SelectPrimitive.Portal>
      ...
      >
        <SelectPrimitive.Popup
          className={cn(
            "cn-select-content cn-menu-target",
            ...
            "relative isolate z-50 max-h-(--available-height) w-(--anchor-width) min-w-36 origin-(--transform-origin) overflow-y-auto overflow-x-hidden duration-100",
