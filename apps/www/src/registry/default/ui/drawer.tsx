      ...
      <DrawerViewport position={position} variant={variant}>
        <DrawerPrimitive.Popup
          className={cn(
            ...
            variant !== "straight" &&
              cn(
                position === "bottom" && "rounded-t-4xl",
                position === "top" &&
                  "rounded-b-4xl **:data-[slot=drawer-footer]:rounded-b-[calc(var(--radius-4xl)-1px)]",
                position === "left" &&
                  "rounded-e-4xl **:data-[slot=drawer-footer]:rounded-ee-[calc(var(--radius-4xl)-1px)]",
                position === "right" &&
                  "rounded-s-4xl **:data-[slot=drawer-footer]:rounded-es-[calc(var(--radius-4xl)-1px)]"
              ),
            variant === "default" &&
              cn(
                position === "bottom" &&
                  "before:rounded-t-[calc(var(--radius-4xl)-1px)]",
                position === "top" &&
                  "before:rounded-b-[calc(var(--radius-4xl)-1px)]",
                position === "left" &&
                  "before:rounded-e-[calc(var(--radius-4xl)-1px)]",
                position === "right" &&
                  "before:rounded-s-[calc(var(--radius-4xl)-1px)]"
              ),
            variant === "inset" &&
              "before:hidden sm:rounded-4xl sm:border sm:after:bg-transparent sm:before:rounded-[calc(var(--radius-4xl)-1px)] sm:**:data-[slot=drawer-footer]:rounded-b-[calc(var(--radius-4xl)-1px)]",
