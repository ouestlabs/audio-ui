...
const knobBodyVariants = cva(
  "absolute z-0 rounded-full border border-border bg-card text-card-foreground shadow-xs transition-transform duration-100 ease-out motion-reduce:transition-none",
  {
    variants: {
      size: {
        sm: "inset-1",
