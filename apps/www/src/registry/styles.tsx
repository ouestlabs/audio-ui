...
export const STYLES = [
  {
    name: "base-luma",
    label: "Luma",
    description: "Soft corners, bright presence.",
    icon: (
      <svg
        aria-hidden="true"
        fill="none"
  ...
  },
  {
    name: "base-nova",
    label: "Nova",
    description: "Rounded confidence.",
    icon: (
      <svg
        aria-hidden="true"
        fill="none"
  ...
  },
  {
    name: "base-vega",
    label: "Vega",
    description: "A squircle of calm.",
    icon: (
      <svg
        aria-hidden="true"
        fill="none"
  ...
  },
  {
    name: "base-maia",
    label: "Maia",
    description: "Perfectly round, endlessly smooth.",
    icon: (
      <svg
        aria-hidden="true"
        fill="none"
  ...
  },
  {
    name: "base-lyra",
    label: "Lyra",
    description: "Hexagonal precision.",
    icon: (
      <svg
        aria-hidden="true"
        fill="none"
  ...
  },
  {
    name: "base-mira",
    label: "Mira",
    description: "Diamond-cut clarity.",
    icon: (
      <svg
        aria-hidden="true"
        fill="none"
  ...
  },
  {
    name: "base-rhea",
    label: "Rhea",
    description: "A pill, slender and serene.",
    icon: (
      <svg
        aria-hidden="true"
        fill="none"
  ...
  },
  {
    name: "base-sera",
    label: "Sera",
    description: "Sharp-cornered authority.",
    icon: (
      <svg
        aria-hidden="true"
        fill="none"
