    ...
    <div className="group/picker relative">
      <Picker>
        <PickerTrigger>
          ...
          <div className="-translate-y-1/2 pointer-events-none absolute top-1/2 right-4 flex size-4 select-none items-center justify-center text-base text-site-foreground *:[svg]:text-site-foreground!">
    ...
    >
      <Item size="xs">
        <ItemContent className="gap-1">
          <ItemTitle className="font-medium text-site-muted-foreground text-xs">
            {iconLibrary.title}
          </ItemTitle>
      ...
      fallback={
        <div className="-mx-1 grid w-full grid-cols-7 gap-2">
          {previewIcons.map((iconName) => (
            <div
              className="site-rounded-sm size-6 animate-pulse bg-site-muted"
              key={iconName}
            />
          ))}
        </div>
