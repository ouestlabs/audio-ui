 ...
 * (shared primitives, hooks, UI, styles). Audio catalog items (`block-*` /
 * `*-demo` under `registry-audio/bases/* /components`) are **not** copied from
 * here — they are ported from apps/www's registry, see plans/002.
 *
