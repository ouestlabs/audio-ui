...
export const designSystemConfigSchema = z
  ...
  // zod v4: refine no longer accepts a message-builder function as the second
  // argument (upstream file targets zod v3 — re-apply this patch after registry:sync).
  .superRefine((data, ctx) => {
    ...
    if (!availableThemes.some((t) => t.name === data.chartColor)) {
      ctx.addIssue({
        code: "custom",
...
export const PRESETS: Preset[] = [
  ...
  },
  {
    name: "base-luma",
    title: "Luma (Base)",
    description: "Luma / Hugeicons / Manrope",
    base: "base",
    style: "luma",
    baseColor: "neutral",
    theme: "neutral",
  ...
  },
  {
    name: "base-rhea",
    title: "Rhea (Base)",
    description: "Rhea / Hugeicons / Manrope",
    base: "base",
    style: "rhea",
    baseColor: "neutral",
    theme: "neutral",
  ...
  },
  {
    name: "base-sera",
    title: "Sera (Base)",
    description: "Sera / Lucide / Instrument Sans",
    base: "base",
    style: "sera",
    baseColor: "neutral",
    theme: "neutral",
