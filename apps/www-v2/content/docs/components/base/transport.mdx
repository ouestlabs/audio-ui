...
<ComponentPreview styleName="base-nova" name="transport-demo" />
...
<ComponentSource
  styleName="base-nova"
  name="transport"
  title="components/audio/transport.tsx"
/>
...
<ComponentPreview styleName="base-nova" name="block-channel-strip-transport" />

#### Vertical

<ComponentPreview styleName="base-nova" name="block-channel-strip-transport-vertical" />
