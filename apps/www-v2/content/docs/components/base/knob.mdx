...
<ComponentSource
  styleName="base-nova"
  name="knob"
  title="components/audio/knob.tsx"
/>
...
<ComponentPreview styleName="base-nova" name="knob-disabled-demo" />

### Size variants

<ComponentPreview styleName="base-nova" name="knob-size-variants-demo" />
...
<ComponentPreview styleName="base-nova" name="knob-arc-and-anchor-demo" />
...
<ComponentPreview styleName="base-nova" name="knob-circular-arc-demo" />

#### Vertical fader-style drag

<ComponentPreview styleName="base-nova" name="knob-vertical-drag-demo" />

#### Revolution (360° reference)

<ComponentPreview styleName="base-nova" name="knob-revolution-drag-demo" />

### Reset with double-tap

<ComponentPreview styleName="base-nova" name="knob-double-tap-reset-demo" />

### Fine step precision (`step={0.01}`)

<ComponentPreview styleName="base-nova" name="knob-fine-step-demo" />

### Live value vs committed value callbacks

<ComponentPreview styleName="base-nova" name="knob-change-vs-commit-demo" />

### Filter cutoff

<ComponentPreview styleName="base-nova" name="knob-filter-control-demo" />

### Channel strip

<ComponentPreview styleName="base-nova" name="block-channel-strip-knob-pan" />

<ComponentPreview styleName="base-nova" name="block-channel-strip-knob-multi" />
