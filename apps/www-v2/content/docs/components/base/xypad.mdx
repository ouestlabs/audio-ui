...
<ComponentPreview styleName="base-nova" name="xypad-live-value-demo" />
...
<ComponentSource
  styleName="base-nova"
  name="xypad"
  title="components/audio/xypad.tsx"
/>
...
<ComponentPreview styleName="base-nova" name="xypad-size-sm-demo" />

#### `default`

<ComponentPreview styleName="base-nova" name="xypad-size-default-demo" />

#### `lg`

<ComponentPreview styleName="base-nova" name="xypad-size-lg-demo" />

#### `xl`

<ComponentPreview styleName="base-nova" name="xypad-size-xl-demo" />

### Disabled state

<ComponentPreview styleName="base-nova" name="xypad-disabled-demo" />

### Custom formatted display

<ComponentPreview styleName="base-nova" name="xypad-format-value-demo" />

### Hidden value display

<ComponentPreview styleName="base-nova" name="xypad-hide-value-demo" />

### Bipolar ranges (pan and mix style)

<ComponentPreview styleName="base-nova" name="xypad-bipolar-range-demo" />

### Live value vs committed value callbacks

<ComponentPreview styleName="base-nova" name="xypad-change-vs-commit-demo" />

### Channel strip

#### Filter pad

<ComponentPreview styleName="base-nova" name="block-channel-strip-xypad-filter" />

#### Reverb pad

<ComponentPreview styleName="base-nova" name="block-channel-strip-xypad-reverb" />
